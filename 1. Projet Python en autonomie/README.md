...
- **Résultats :** La guerre est une thématique importante comparée à d'autres sujets, la rhétorique de guerre est croissante, de manière positive et significative ces dernières années dans les discours présidentiels, la rhétorique de guerre s'étend de plus en plus à d'autres thématiques (la relation est positive et significative).

- **Discussions :** l'analyse de réseau semble être la piste la plus pertinente pour mesurer l'évolution sémantique globale des discours présidentiels français, nécessitant un encadrement par un Master spécialisé

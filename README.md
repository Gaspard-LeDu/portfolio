...
- **Construction médiatique des problèmes publics** : *"Partage des tâches ménagères & Convictions politiques"* | Nettoyage de données - Recodage - Analyse univariée - Analyse bivariée - Tableaux croisés et tests d’association (Khi², V de Cramer) - Régression linéaire | Note finale : (/20)

- **Introduction aux méthodes statistiques** : *"Partage des tâches ménagères & Convictions politiques"* | Nettoyage de données - Recodage - Analyse univariée - Analyse bivariée - Tableaux croisés et tests d’association (Khi², V de Cramer) - Régression linéaire | Note finale : (15/20)
